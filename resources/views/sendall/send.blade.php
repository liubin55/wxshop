...
@section('content')
    <div style="float: left;border: #00F7DE 2px solid;margin-left: 100px;margin-top: 50px;padding: 20px">
        <h2 style="color: #1b4b72;margin-top: 20px;margin-bottom: 20px">添加群消息</h2>
        <label class="layui-form-label">选择添加类型：</label>

        <form action="{{url('send/sendDo')}}" method="post" enctype="multipart/form-data">
            <select  name="type" id="type_">
                <option value="thumb">图文</option>
