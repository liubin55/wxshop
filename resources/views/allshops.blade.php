...
<script>
    ...
    $("#txtSearch").blur(function () {
        ...
        var _type=$("#ulOrderBy li[class='current']").attr('_type');
        var top=$("#ulOrderBy li[class='current']").children('a').children('span').text();
        $.ajax({
            type:"post",
            url:"{{url('sortshop')}}",
            data:{textsearch:textsearch,_token:_token,_type:_type,cate_id:cate_id,top:top},
        }).done(function (res) {
            $("#box").html(res);
        })
    })
    ...
    $("#ulOrderBy li").click(function(){
        ...
        $.ajax({
            type:'post',
            url:"{{url('sortshop')}}",
            data:{textsearch:textsearch,_type:_type,_token:_token,cate_id:cate_id,top:top}
        }).done(function (res) {
            $("#box").html(res);
            if(top=='↑'){
